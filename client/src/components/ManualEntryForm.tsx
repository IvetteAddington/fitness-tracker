...
export default function ManualEntryForm() {
  ...
  const handleExerciseChange = (workoutIndex: number, exerciseIndex: number, field: 'name' | 'sets' | 'reps' | 'notes', value: any) => {
    const newWorkouts = [...workouts];
  ...
  return (
    ...
    >
      <button
        ...
        className="w-full text-center bg-[#E83E8C] text-white font-['Bebas_Neue'] text-xl px-4 py-2 rounded shadow hover:bg-opacity-90 transition-all"
      >
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="mt-4">
          <div className="mb-4">
            <label className="block font-['Courier_Prime'] text-[#4CAF50] mb-1">Plan Name:</label>
            <input
              type="text"
              value={planName}
              onChange={(e) => setPlanName(e.target.value)}
              className="w-full p-2 border border-[#E83E8C] bg-white rounded"
              placeholder="e.g., 6-Week Strength Builder"
            />
          </div>

          <div className="mb-4">
            <label className="block font-['Courier_Prime'] text-[#4CAF50] mb-1">Total Days:</label>
            <input
              type="number"
              min="1"
              max="60"
          ...
          <div className="my-6">
            <h3 className="font-['Bebas_Neue'] text-[#4CAF50] text-xl border-b border-[#E83E8C] pb-1 mb-4">
              WORKOUTS
            </h3>
            ...
            {workouts.map((workout, workoutIndex) => (
              ...
              >
                ...
                <div className="mb-3">
                  <label className="block font-['Courier_Prime'] text-[#4CAF50] text-sm mb-1">
                    Workout Name:
                  </label>
                  <input
                    type="text"
                ...
                <h5 className="font-['Bebas_Neue'] text-[#4CAF50] mt-4 mb-2">
                  EXERCISES
                </h5>
